...
function ForgotPasswordForm() {
  ...
  const statusMessage =
    status === "invalid-link"
      ...
      : status === "missing-code"
        ? "Reset link expired, was already used, or is incomplete. Request a new link below."
        : null;
  ...
  useEffect(() => {
    ...
    toast.success(`${state.success} If you do not see it, check spam/promotions in a minute.`);
  }, [state?.success, toast]);
